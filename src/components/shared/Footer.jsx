    ...
    <footer className="footer">
      <div className="container">
        <div className="footer-content">
          <div className="footer-section">
            ...
            <p>
              ...
              sellers, and agents to create seamless real estate experiences.
            </p>
        ...
        <div className="footer-bottom">
          <p>&copy; {currentYear} Elite Properties. All rights reserved. | Privacy Policy | Terms of Service</p>
        </div>
      </div>
    </footer>
  );
